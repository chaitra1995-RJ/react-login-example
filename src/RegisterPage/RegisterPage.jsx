...
class RegisterPage extends React.Component {
    ...
    handleSubmit(event) {
        ...
        const { user } = this.state;
        if (user.firstName && user.lastName && user.age && user.gender && user.phone_number && user.username && user.password) {
        ...
        return (
            <div className="col-md-6 col-md-offset-3">
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className={'form-group' + (submitted && !user.pone_number ? ' has-error' : '')}>
                        ...
                        {submitted && !user.phone_number &&
                            <div className="help-block">phone_number is required</div>
                        }
                    </div>
